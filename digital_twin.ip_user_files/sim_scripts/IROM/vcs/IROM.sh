...
design_libs=(xpm dist_mem_gen_v8_0_14 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work dist_mem_gen_v8_0_14 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.IROM xil_defaultlib.glbl -o IROM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./IROM_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key IROM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc IROM_simv.daidir vcs_lib c.obj)
