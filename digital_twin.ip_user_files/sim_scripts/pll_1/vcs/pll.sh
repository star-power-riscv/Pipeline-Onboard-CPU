...
#
# Script generated by Vivado on Thu Jun 19 18:20:07 UTC 2025
...
#
# Usage        : pll.sh
#                pll.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pll.sh [-reset_run]
#                pll.sh [-reset_log]
#                pll.sh [-help]
#
...
#                script (type 'pll.sh -help' for more information).
#
...
# script info
echo -e "pll.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pll.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"../../../../digital_twin.gen/sources_1/ip/pll" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"../../../../digital_twin.gen/sources_1/ip/pll" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pll xil_defaultlib.glbl -o pll_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pll_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/easton/Pipeline-Onboard-CPU/digital_twin.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key pll_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pll_simv.daidir vcs_lib c.obj)
...
Usage: pll.sh [-reset_log]\n\
Usage: pll.sh [-keep_index]\n\
