...
#
# Script generated by Vivado on Thu Jun 19 13:23:49 +0800 2025
...
#
# Usage        : DRAM.sh
#                DRAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DRAM.sh [-reset_run]
#                DRAM.sh [-reset_log]
#                DRAM.sh [-help]
#
...
#                script (type 'DRAM.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname dist_mem_gen_v8_0_14 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm dist_mem_gen_v8_0_14 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "DRAM.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DRAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work dist_mem_gen_v8_0_14 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.DRAM xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.DRAM -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log DRAM_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DRAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DRAM.sh [-help]\n\
Usage: DRAM.sh [-step]\n\
Usage: DRAM.sh [-lib_map_path]\n\
Usage: DRAM.sh [-reset_run]\n\
Usage: DRAM.sh [-reset_log]\n\
Usage: DRAM.sh [-keep_index]\n\
Usage: DRAM.sh [-noclean_files]\n\n\
