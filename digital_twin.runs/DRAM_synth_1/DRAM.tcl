...
synth_design -top DRAM -part xc7k325tffg900-2 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp DRAM.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips DRAM]
 }
